                    ...
                    <div class="sub-topic">
                        ...
                        <div class="description">
                            <ul>
                                ...
                                <li>Reinigung von Verbindungsstücken von Zentralheizungen für feste Brennstoffe</li>
                                <li>Abgaswegeprüfungen an Gas und Ölheizungsanlagen</li>
                                <li>Überprüfung von Dunstabzugsanlagen</li>
                            </ul>
                        </div>
                    </div>
                    <div class="sub-topic">
                        ...
                        <div class="description">
                            <ul>
                                ...
                                <li>Gasheizungsanlagen</li>
                                <li>Zentralheizungsanlagen für feste Brennstoffe</li>
                            </ul>
                        </div>
                    </div>
                    <div class="sub-topic">
                        ...
                        <div class="description">
                            <ul>
                                ...
                                <li>Hart- und Glanzrußbeseitigung im Schornstein (Spezialreinigung mittels unterschiedlicher Kettenausschlaggeräte)</li>
                                <li>Überprüfung und Reinigung von Lüftungsschächten</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="topic">
                ...
                <div class="description">
                            <ul>
                                ...
                                <li>Ermittlung der Ableitbedingungen nach 1.BimSchV und VDI 3781</li>
                            </ul>
                        </div>
            </div>
            <div class="topic">
